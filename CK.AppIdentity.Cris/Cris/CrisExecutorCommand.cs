...
{
    /// <summary>
    /// Base class for Cris command that must be executed.
    /// This can be specialized for specific end point.
    /// <para>
    ...
    /// </para>
    /// </summary>
    public abstract class CrisExecutorCommand
    {
        /// <summary>
        /// Initialize a new <see cref="CrisExecutorCommand"/> from its data (typically used when
        /// deserializing).
        /// </summary>
        /// <param name="payload">The command.</param>
        /// <param name="issuerToken">The issuer token.</param>
        protected CrisExecutorCommand( IAbstractCommand payload, ActivityMonitor.Token issuerToken )
        {
