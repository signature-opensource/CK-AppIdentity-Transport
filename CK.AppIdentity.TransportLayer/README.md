...
- The prefix starts with a first byte: `|L0|L1|R|P0|P1|P2|P3|P4|`.
  ...
  - P0-P4 bits is the Protocol, a number between 0 and 32. This number defines the "type" of the
...
negotiate the ones they can and want to use. Any Transport between 2 parties can support up to 31 different protocols.

The final length of a message on the wire is between 2 bytes (the special Empty message, see below) and 2 Gib.
A minimal 1 byte message requires 3 bytes (in any of the 31 available protocols). 
