...
## Message Prefix: Encoding Protocol and Length
...
can be any number of existing encodings, among them 2 parties can exchange up to 31 different type of messages (or said
differently support up to 31 different protocols).
