...
{
    /// <summary>
    /// Read only view of a <see cref="TransportMessageImpl"/> that can be retained or disposed.
    /// <para>
    ...
    public interface ITransportMessage : ITransportMessageData
    {
        ...
        /// Calling this on the special messages <see cref="TransportMessage.Invalid"/>, <see cref="TransportMessageImpl.Canceled"/>,
        ...
        /// The <see cref="TransportMessage.Invalid"/>, <see cref="TransportMessageImpl.Canceled"/>, <see cref="TransportMessage.Empty"/>
